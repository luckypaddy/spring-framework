...
public class StompSubProtocolHandlerTests {
	...
	public void handleFragmentedStompFrame() {
		...
		Map<String, ByteBuffer> stompFrameBuffers =
				(Map<String, ByteBuffer>)protocolHandlerFieldAccessor.getPropertyValue("stompDecoders");
	...
	@Test
	public void handleFragmentedStompFrameWithFirstFragmentTooBig() {
		this.protocolHandler.setMaxFrameBufferSize(8);
		DirectFieldAccessor protocolHandlerFieldAccessor = new DirectFieldAccessor(this.protocolHandler);
		Map<String, ByteBuffer> stompFrameBuffers =
				(Map<String, ByteBuffer>)protocolHandlerFieldAccessor.getPropertyValue("stompDecoders");
		TextMessage textMessage1 = new TextMessage("SEND\n\nthis is");
	...
	@Test
	public void handleFragmentedStompFrameWithLastFragmentTooBig() {
		this.protocolHandler.setMaxFrameBufferSize(15);
		DirectFieldAccessor protocolHandlerFieldAccessor = new DirectFieldAccessor(this.protocolHandler);
		Map<String, ByteBuffer> stompFrameBuffers =
				(Map<String, ByteBuffer>)protocolHandlerFieldAccessor.getPropertyValue("stompDecoders");
		TextMessage textMessage1 = new TextMessage("SEND\n\nthis is");
